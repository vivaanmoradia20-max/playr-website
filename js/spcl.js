...
window.renderSpcl=function(){
  ...
  <div class="spcl-hero">
    ...
    <div class="wrap spcl-hero-in">
      <div class="spcl-brandchip">🔷 SPCL · A PLAYR COMMUNITY</div>
      ...
      <div class="spcl-hero-btns">
        <button class="btn btn-primary" onclick="SPCL.scrollTo('spcl-sports')">Explore SPCL</button>
  ...
  <div class="wrap spcl-what rv">
    <div class="spcl-what-left">
      <div class="eyebrow">SPCL — Sports for Every Capability. Limitless Potential.</div>
      <h2 class="section-title">SKILL. COMPETITION.<br>COMMUNITY.</h2>
      <p>SPCL is PLAYR's dedicated community for Para athletes, Para sports and the people who follow them — bringing competition, stories, athletes, history, events and community together in one place.</p>
      ...
      <p class="spcl-disclaimer">SPCL is PLAYR's own Para-sport community brand. It is not the IPC, the Paralympic movement or any official organisation — official information is credited to its sources.</p>
    </div>
  </div>
  ...
  <div class="spcl-sec wrap" id="spcl-athletes">
    <div class="cat-head"><div class="cat-ic" style="--x:${ACC}">🥇</div><div><h3 class="cat-name">SPCL ATHLETES</h3><p class="cat-blurb">Verified profiles carry public, documented achievements. Demo profiles are badged DEMO.</p></div></div>
  ...
  <div class="spcl-sec wrap" id="spcl-sports">
    <div class="cat-head"><div class="cat-ic" style="--x:${ACC}">🔷</div><div><h3 class="cat-name">EXPLORE PARA SPORTS</h3><p class="cat-blurb">The IPC's current sanctioned Para-sport listing — 23 summer and 6 winter. Tap any sport to enter its SPCL universe.</p></div>
  ...
  <div class="spcl-sec wrap" id="spcl-feed">
    <div class="cat-head"><div class="cat-ic" style="--x:${ACC}">⚡</div><div><h3 class="cat-name">YOUR SPCL FEED</h3><p class="cat-blurb">Athlete posts, competition updates, training stories and records — the same social system as PLAYR.</p></div></div>
  ...
  <div class="spcl-sec wrap" id="spcl-events">
    <div class="cat-head"><div class="cat-ic" style="--x:${ACC}">🏟️</div><div><h3 class="cat-name">SPCL HAPPENING NOW</h3><p class="cat-blurb">Live, upcoming and recent — verified where possible, demo where labelled.</p></div>
    ...
    <div class="spcl-events-grid">
      ...
      <div class="spcl-ev card demo">
        ...
        <p>Four teams, one trophy, the loudest crowd in the hall. Demo community fixture on the SPCL calendar.</p>
  ...
  <div class="spcl-sec wrap" id="spcl-communities">
    <div class="cat-head"><div class="cat-ic" style="--x:${ACC}">👥</div><div><h3 class="cat-name">SPCL COMMUNITIES</h3><p class="cat-blurb">Members, posts, events, challenges, athletes and discussions — built around each sport.</p></div></div>
  ...
  <div class="spcl-sec wrap" id="spcl-india">
    <div class="cat-head"><div class="cat-ic" style="--x:${ACC}">🇮🇳</div><div><h3 class="cat-name">PARA SPORT INDIA</h3><p class="cat-blurb">PLAYR launches in India — this is the home of Indian Para sport on SPCL.</p></div></div>
  ...
  <div class="spcl-sec wrap" id="spcl-challenges">
    <div class="cat-head"><div class="cat-ic" style="--x:${ACC}">🧠</div><div><h3 class="cat-name">SPCL CHALLENGES</h3><p class="cat-blurb">Recreational only — predictions, trivia and knowledge. No risky physical challenges on SPCL, ever.</p></div></div>
    <div class="grid grid-3">
      ${[["Para Sport History Quiz","10 rounds from Stoke Mandeville to Nagoya.","PLAY NOW"],["Predict the Finalist","Call the finals before they happen — no stakes but pride.","PREDICT"],["Name That Para Sport","Identify the most Para-sport events from their classes.","START"],["Classification Basics","Learn how classes work — 5 questions, all levels.","LEARN"]].map(c=>`
        <div class="spcl-chz card"><b>${c[0]}</b><p>${c[1]}</p><button class="btn btn-ghost btn-sm" onclick="showToast('${c[0]} — opening on SPCL ⚡')">${c[2]}</button></div>`).join("")}
    </div>
  </div>
  ...
  <div class="spcl-sec wrap" id="spcl-shop">
    <div class="spcl-shop-banner card">
      <div>
        <div class="pill pill-lime" style="margin-bottom:12px;">SPCL DROP</div>
        <h4>SPORTS FOR EVERY CAPABILITY.<br>LIMITLESS POTENTIAL.</h4>
        <p>PLAYR-original SPCL merch — no IPC or Paralympic affiliation, just the community's colours.</p>
      </div>
      <button class="btn btn-primary" onclick="switchView('shop')">Shop SPCL →</button>
    </div>
  </div>`;
...
const SPCL_POSTS={
  foryou:[
    ...
    {who:"SPCL History",tag:"On this day",t:"5h",txt:"1948: an archery contest at Stoke Mandeville Hospital plants the seed of the entire Paralympic movement.",likes:5402,com:173},
  ...
  trending:[
    {who:"SPCL",tag:"Records",t:"1d",txt:"Sumit Antil's F64 javelin world records: the benchmark keeps moving. Full stats in the Para Athletics universe. 🎯",likes:8602,com:340},
    ...
    {who:"SPCL",tag:"Classification",t:"2d",txt:"Sport-specific, activity-based, athlete-first. If classification confuses you, our 60-second guide is in the Classification tab. 🧭",likes:4110,com:97}
  ]
};
...
function openSpclSport(id){
  ...
  <div class="su2-hero" style="--accent:${ACC}; background:linear-gradient(135deg, ${ACC}2E 0%, #0A0B0D 100%)">
    ...
    <div class="su2-in">
      ...
      <div class="su2-note"><b>SPORT WITHOUT LIMITS</b> — SPCL universes celebrate performance first. Classification details stay with athletes and classifiers.</div>
    </div>
  </div>
  ...
  <div class="maylike"><div class="fy-row-head"><div class="eyebrow" style="margin:0">More SPCL worlds</div></div>
...
window.renderSpclHome=function(){
  ...
  el.innerHTML=`<div class="wrap">
    <div class="cat-head"><div class="cat-ic" style="--x:${ACC}">🔷</div><div><h3 class="cat-name">SPCL — SPORTS FOR EVERY CAPABILITY.<br>LIMITLESS POTENTIAL.</h3><p class="cat-blurb">PLAYR's Para-sport ecosystem — athletes, competitions, history and community in one place.</p></div>
      <button class="btn btn-primary btn-sm" style="margin-left:auto;" onclick="switchView('spcl')">Explore SPCL</button></div>
...
window.renderSpclShop=function(){
  ...
  el.innerHTML=`<div class="wrap">
    <div class="drop-banner spcl-drop">
      <div>
        <div class="pill" style="margin-bottom:12px;background:rgba(77,166,255,.14);color:${ACC};border:1px solid rgba(77,166,255,.35);">SPCL — Sports for Every Capability. Limitless Potential.</div>
        <h3 style="font-family:var(--display);font-size:32px;text-transform:uppercase;">THE SPCL DROP</h3>
        <p style="color:var(--muted);margin-top:6px;max-width:460px;">PLAYR-original SPCL merch. Not affiliated with the IPC or any official Paralympic merchandise.</p>
      </div>
    </div>
    <div class="grid grid-4">
      ${window.SPCL_MERCH.map(m=>`<div class="card product-card"><div class="product-media spcl-merch-ic">${m.icon}</div><div class="product-body"><div class="product-cat">SPCL</div><div class="product-name">${m.n}</div><div class="product-row"><span class="product-price">${m.p}</span><button class="btn btn-primary btn-sm" onclick="showToast('Added to cart')">Shop Now</button></div></div></div>`).join("")}
    </div>
  </div>`;
};
