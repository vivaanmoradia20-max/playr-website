...
function renderEventsPage(){
  ...
  <div class="ev-sec" id="browseSec">
    ...
    <div class="ev-filterbar">
      ...
      <div class="ev-f-group"><label>SPCL PLAYERS / Para sport</label><div class="ev-f-chips"><button class="attr-pill ${!F.para?"on":""}" onclick="PLAYR_EV.setPara(false)">All events</button><button class="attr-pill ${F.para?"on":""}" onclick="PLAYR_EV.setPara(true)">SPCL PLAYERS — Para sports only</button></div></div>
